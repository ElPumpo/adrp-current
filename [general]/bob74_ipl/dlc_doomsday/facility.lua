...
DoomsdayFacility = {
    ...
    Details = {
        ...
        crewEmblem = "set_int_01_crewemblem",
    ...
    LoadDefault = function()
        ...
        DoomsdayFacility.Decals.Set(DoomsdayFacility.Decals.style02)
        ...
        DoomsdayFacility.Details.Enable({DoomsdayFacility.Details.Clutter.D, DoomsdayFacility.Details.Clutter.C}, true)
