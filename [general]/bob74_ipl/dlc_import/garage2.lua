...
ImportCEOGarage2 = {
    ...
    LoadDefault = function()
        ...
        ImportCEOGarage2.Style.Set(ImportCEOGarage2.Part.Garage1, ImportCEOGarage2.Style.marble, true)
        ImportCEOGarage2.Numbering.Set(ImportCEOGarage2.Part.Garage1, ImportCEOGarage2.Numbering.Level1.style9, true)
        ImportCEOGarage2.Lighting.Set(ImportCEOGarage2.Part.Garage1, ImportCEOGarage2.Lighting.style8, true)
        
        ImportCEOGarage2.Part.Load(ImportCEOGarage2.Part.ModShop)
        ImportCEOGarage2.ModShop.Floor.Set(ImportCEOGarage2.ModShop.Floor.grid, true)
    end
}
