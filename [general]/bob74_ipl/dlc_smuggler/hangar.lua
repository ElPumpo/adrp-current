...
SmugglerHangar = {
    ...
    LoadDefault = function()
        ...
        SmugglerHangar.Walls.SetColor(SmugglerHangar.Colors.colorSet8)
        SmugglerHangar.Cranes.Set(SmugglerHangar.Cranes.on, SmugglerHangar.Colors.colorSet9)
        SmugglerHangar.Floor.Style.Set(SmugglerHangar.Floor.Style.plain)
        SmugglerHangar.Floor.Decals.Set(SmugglerHangar.Floor.Decals.decal8, SmugglerHangar.Colors.colorSet1)
