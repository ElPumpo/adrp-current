...
Config2.Zones = {
	CokeFarm      = {location = vector3(-2080.8, 2611.0, 3.0), label = '~o~Farm Coke~s~', item = 'coke', required = nil, required_count = 1, time = 10},
	...
	MethCollect = {location = vector3(-2288.5, 210.6, 167.6), label = '~o~Farm Meth~s~', item = 'meth', required = nil, required_count = 1, time = 10},
