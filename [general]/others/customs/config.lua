local colors = {
	...
	{name = "Midnight Blue", colorindex = 141},{name = "BubbleGum Blue", colorindex = 140},
...
------Neon layout------
	neonlayout = {
		...
		{name = "Front and Back", price = 2000},
		{name = "Sides", price = 2000},
	},
	--Neon color
	neoncolor = {
...
LSC_Config.VehicleLifts = {
	vector3(-1200.8, -1718.0, 4.4),
	vector3(-1207.4, -1722.7, 4.4),
	vector3(-1193.7, -1713.0, 4.4),
	vector3(-1186.2, -1708.2, 4.4),
	vector3(-1179.3, -1703.2, 4.4),
	vector3(978.1, -2994.3, -39.6)
}