...
local isInLiftMarker = false

-- IMPORTANT NOTE TO EDITORS
-- FROM HAWAII
-- TO WHOEVER TOUCHES THE LINES BELOW
-- WHEN YOU ADD A GARAGE, DO NOT FORGET TO
-- ADD THE SAME GARAGE IN SERVER.LUA
-- JUST ADD THE NUMBER AS SEEN THERE,
...
local garages = {
	...
	[5] = { label = 'Beeker\'s Garage', locked = false, camera = {x = 105.825, y = 6627.562, z = 31.787, heading = 266.692}, driveout = {x = 112.326,y = 6625.148, z = 31.073, heading = 224.641}, drivein = {x = 112.738,y = 6624.644, z = 31.072, heading = 44.262}, outside = {x = 118.493,y = 6618.897, z = 31.13, heading = 224.701}, inside = {x = 108.842,y = 6628.447, z = 31.072, heading = 45.504}},
	[6] = { hide = true, locked = false, camera = {x = 962.336, y = -3005.562, z = -47.557, heading = 182.152}, driveout = {x = 962.336, y = -3005.562, z = -47.787, heading = 182.152}, drivein = {x = 962.336, y = -3005.562, z = -47.787, heading = 182.152}, outside = {x = 962.336, y = -3005.562, z = -47.787, heading = 182.152}, inside = {x = 962.336, y = -3005.562, z = -47.787, heading = 182.152}},
	[7] = { hide = true, locked = false, camera = {x = 954.336, y = -3005.992, z = -47.557, heading = 182.152}, driveout = {x = 954.336, y = -3005.992, z = -47.557, heading = 182.152}, drivein = {x = 954.336, y = -3005.992, z = -47.557, heading = 182.152}, outside = {x = 954.336, y = -3005.992, z = -47.557, heading = 182.152}, inside = {x = 954.336, y = -3005.992, z = -47.557, heading = 182.152}},
	[8] = { hide = true, locked = false, camera = {x = 970.336, y = -3005.532, z = -47.557, heading = 182.152}, driveout = {x = 970.336, y = -3005.532, z = -47.557, heading = 182.152}, drivein = {x = 970.336, y = -3005.532, z = -47.557, heading = 182.152}, outside = {x = 970.336, y = -3005.532, z = -47.557, heading = 182.152}, inside = {x = 970.336, y = -3005.532, z = -47.557, heading = 182.152}},
	[9] = { hide = true, locked = false, camera = {x = 978.336, y = -3005.532, z = -47.557, heading = 182.152}, driveout = {x = 978.336, y = -3005.532, z = -47.557, heading = 182.152}, drivein = {x = 978.336, y = -3005.532, z = -47.557, heading = 182.152}, outside = {x = 978.336, y = -3005.532, z = -47.557, heading = 182.152}, inside = {x = 978.336, y = -3005.532, z = -47.557, heading = 182.152}},
	[10] = { hide = true, locked = false, camera = {x = 1109.675, y = -3154.562, z = -37.787, heading = 347.152}, driveout = {x = 1109.675, y = -3154.562, z = -37.787, heading = 347.152}, drivein = {x = 1109.675, y = -3154.562, z = -37.787, heading = 347.152}, outside = {x = 1109.675, y = -3154.562, z = -37.787, heading = 347.152}, inside = {x = 1109.675, y = -3154.562, z = -37.787, heading = 347.152}},
	[11] = { hide = true, locked = false, camera = {x = -215.518, y = -1329.135, z = 30.89, heading = 149.092}, driveout = {x = -207.735,y = -1321.542, z = 30.176, heading = 346.895}, drivein = {x = -213.726,y = -1331.79, z = 30.847, heading = 342.395}, outside = {x = -205.694,y = -1312.985, z = 31.614, heading = 1.592}, inside = {x = -211.368,y = -1324.086, z = 30.176, heading = 338.107}},
	[12] = { hide = true, locked = false, camera = {x = 998.918, y = -3145.235, z = -37.89, heading = 189.992}, driveout = {x = 1000.035,y = -3150.042, z = -38.876, heading = 178.895}, drivein = {x = 1000.126,y = -3154.89, z = -38.947, heading = 7.695}, outside = {x = 999.994,y = -3154.085, z = -38.614, heading = 171.892}, inside = {x = 999.868,y = -3148.586, z = -38.176, heading = 2.007} }
}
...
local function AddMod(mod,parent,header,name,info,stock)
	...
	if (GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) > 0) or mod == 18 or mod == 22 or liveryCount > 0 then
		...
		for i = 1, liveryCount do
			local lbl = GetLabelText(GetLiveryName(veh, i))
			if lbl == "NULL" then
				local btn = m:addPurchase("Livery",2000)
				btn.modtype = mod
				btn.mod = i
			else

				local btn = m:addPurchase(lbl,2000)
				btn.modtype = mod
				btn.mod = i
			end
...
local function DriveInGarage()
	...
	if DoesEntityExist(veh) then
		...
		respray = LSCMenu.categories:addSubMenu("RESPRAY", "Respray", "Transforms vehicle appearance.",true)
			...
			acol = respray:addSubMenu("ACCENT COLORS", "Accent color",  nil,true)
				acol:addSubMenu("CLASSIC", "Classic", nil,true)
				for n, c in pairs(LSC_Config.prices.classic.colors) do
					local btn = acol.Classic:addPurchase(c.name,LSC_Config.prices.classic.price)btn.colorindex = c.colorindex
					if btn.colorindex == myveh.color[1] then
						btn.purchased = true
					end
				end
...
local function DriveOutOfGarage(pos)
	Citizen.CreateThread(function()
		...
		DisplayRadar(true)
		SetPlayerControl(PlayerId(),true)
		TriggerEvent('ui:toggle', true, false)
			...
			if IsPedSittingInAnyVehicle(ped) then
				...
				if DoesEntityExist(veh) and GetPedInVehicleSeat(veh, -1) == ped and (IsThisModelACar(GetEntityModel(veh)) or IsThisModelABike(GetEntityModel(veh))) then
					...
					for i,pos in ipairs(garages) do
						...
						if GetDistanceBetweenCoords(outside.x,outside.y,outside.z,GetEntityCoords(ped)) <= 5 then
							letSleep = false
								...
								if pos.locked then
									...
									if not LSC_Config.lock then
										if IsControlJustPressed(1,201) then
											...
											drawTxt("Press ~b~ENTER~s~ to enter ~b~Los Santos Customs",4,1,0.5,0.8,1.0,255,255,255,255)
										end
									else
...
function LSCMenu:onSelectedIndexChanged(name, button)
	...
	if m == "chrome" or m ==  "classic" or m ==  "matte" or m ==  "metals" then
		...
		elseif p == "accent color" then
			SetVehicleDashboardColour(veh,button.colorindex,myveh.color[3])
		end
...
AddEventHandler("LSC:buttonSelected", function(name, button, canpurchase)
	...
	elseif mname == "neon layout" then
		...
		elseif button.purchased or CanPurchase(price, canpurchase) then
			...
			if button.name == 'Front, Back and Sides' then
				SetVehicleNeonLightEnabled(veh,0,true)
				SetVehicleNeonLightEnabled(veh,1,true)
				SetVehicleNeonLightEnabled(veh,2,true)
				SetVehicleNeonLightEnabled(veh,3,true)
			elseif button.name == 'Front and Back' then
				SetVehicleNeonLightEnabled(veh,0,false)
				SetVehicleNeonLightEnabled(veh,1,false)
				SetVehicleNeonLightEnabled(veh,2,true)
				SetVehicleNeonLightEnabled(veh,3,true)
			elseif button.name == 'Sides' then
				SetVehicleNeonLightEnabled(veh,0,true)
				SetVehicleNeonLightEnabled(veh,1,true)
				SetVehicleNeonLightEnabled(veh,2,false)
				SetVehicleNeonLightEnabled(veh,3,false)
...
function LSCMenu:OnMenuChange(last,current)
	...
	local isBike = IsThisModelABike(GetEntityModel(myveh.vehicle))
	c = current.name:lower()

	if c == "front bumpers" then
		MoveVehCam('front',-0.6,1.5,0.4)
	elseif c == 'brakes' then
		MoveVehCam("left",-1.4,0.6,0.3)
	...
	elseif (c == 'wheel type' or c == 'wheels') and not isBike then
		PointCamAtBone("wheel_lf",-1.4,0,0.3)
	elseif c == "front wheel" or  c == "wheel color" or c == 'wheel accessories' or c == "sport" or c == "muscle" or c == "lowrider"  or c == "highend" or c == "suv" or c == "offroad" or c == "tuner" then
		PointCamAtBone("wheel_lf",-1.4,0,0.3)
	elseif c == "windows" and not isBike then
		PointCamAtBone("window_lf",-2.0,0,0.3)
	elseif c == "neon kits" or c == 'neon color' or c == 'neon layout' then
...
function CheckPurchases(m)
	...
	elseif name == "neon layout" then
		local front = IsVehicleNeonLightEnabled(myveh.vehicle, 2)
		local back = IsVehicleNeonLightEnabled(myveh.vehicle, 3)
		local left = IsVehicleNeonLightEnabled(myveh.vehicle, 0)
		local right = IsVehicleNeonLightEnabled(myveh.vehicle, 1)

		for i,b in pairs(m.buttons) do
			if b.name == "None" then
				if not front and not back and not left and not right then
					b.sprite = "garage"
				else
					b.sprite =  nil
				end
			elseif b.name == "Front, Back and Sides" then
				if front and back and left and right then
					b.sprite = "garage"
				else
					b.sprite =  nil
				end
			elseif b.name == 'Front and Back' then
				if front and back and not left and not right then
					b.sprite = "garage"
				else
					b.sprite =  nil
				end
			elseif b.name == 'Sides' then
				if not front and not back and left and right then
					b.sprite = "garage"
				else
					b.sprite =  nil
				end
...
Citizen.CreateThread(function()
	for k,v in ipairs(garages) do
		if not v.hide then
			...
			AddTextComponentSubstringPlayerName(v.label or 'Los Santos Customs')
...
Citizen.CreateThread(function()
	while true do
		...
		if ESX.PlayerData.gang and (ESX.PlayerData.gang.name == 'lostmotors' or ESX.PlayerData.gang.name == 'redlinecrew') then
			local playerPed = PlayerPedId()
			local playerCoords = GetEntityCoords(playerPed)
			local vehicle = ESX.Game.GetClosestVehicle()
			local vehicleCoords = GetEntityCoords(vehicle)

			for k,v in ipairs(LSC_Config.VehicleLifts) do
				if #(playerCoords - v) < 1.0 then
					isInLiftMarker = true
					ESX.ShowHelpNotification('Press ~INPUT_PICKUP~ to ~y~Lift the Vehicle~s~.')
					break
				elseif isInLiftMarker then
					isInLiftMarker = false
				end
			end
		end

		if IsControlJustReleased(0, 38) and isInLiftMarker then
			if not pressed then
				local vehcount = 6.00
				vehicleCoords = GetOffsetFromEntityInWorldCoords(vehicle, 0.0, 0.0, 1.0)
				SetEntityCoordsNoOffset(vehicle,  vehicleCoords.x,  vehicleCoords.y,  vehcount,  0, 0, 0)
				if vehcount >= 6.00 then
					FreezeEntityPosition(vehicle, true)
					pressed = true
				end
			else
				SetEntityCoordsNoOffset(vehicle,  vehicleCoords.x,  vehicleCoords.y,  4.412,  0, 0, 0)
				SetVehicleOnGroundProperly(vehicle)
				FreezeEntityPosition(vehicle, false)
				pressed = false
			end

			if isInLiftMarker and not hasAlreadyEnteredMarker then
				hasAlreadyEnteredMarker = true
			end

			if not isInLiftMarker and hasAlreadyEnteredMarker then
				hasAlreadyEnteredMarker = false
			end
		end

		if not isInLiftMarker then
			Citizen.Wait(500)
		end
	end
end)