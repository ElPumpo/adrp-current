...
AddEventHandler('esx_adrp_vehicle:onToggleVehicleLock', function(plate, targetId)
	...
	if lockStatus == 1 then -- unlocked
		...
		if targetId == PlayerId() then
			TriggerEvent('customNotification', 'Your vehicle has been <span style="color:red;">locked</span>')
		end
	elseif lockStatus == 4 then -- locked
		...
		if targetId == PlayerId() then
			TriggerEvent('customNotification', 'Your vehicle has been <span style="color:#00ea1b;">unlocked</span>')
		end
	end
end)
