...
AddEventHandler('esx:setJob', function(playerId, job, lastJob)
	...
	TriggerEvent('esx_scoreboard:updateConnectedPlayers', connectedPlayers)
end)
...
AddEventHandler('esx_scoreboard:identityUpdated', function(playerId, newName)
	connectedPlayers[playerId].name = sanitize(newName)

	TriggerClientEvent('esx_scoreboard:updateConnectedPlayers', -1, connectedPlayers)
	TriggerEvent('esx_scoreboard:updateConnectedPlayers', connectedPlayers)
end)

AddEventHandler('esx_scoreboard:getConnectedPlayers', function(cb)
	cb(connectedPlayers)
end)
...
function AddPlayerToScoreboard(xPlayer, update)
	...
	if connectedPlayers[playerId].ping == 0 then
		connectedPlayers[playerId] = nil
	else
		if update then
			TriggerClientEvent('esx_scoreboard:updateConnectedPlayers', -1, connectedPlayers)
