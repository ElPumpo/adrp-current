...
Config.Zones = {
	Clocking = {
		Pos	 = { x = -206.832, y = -1335.303, z = 33.598 },
	...
	MecanoActions = {
		Pos	 = { x = -213.497, y = -1333.903, z = 33.89 },
		Size	= { x = 2.0, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type	= 1,
	},
	...
	Garage = {
		Pos	 = { x = -196.794, y = -1319.669, z = 29.610 },
		Size	= { x = 2.0, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type	= 1,
	},
	...
	Craft = {
		Pos	 = { x = -198.749, y = -1315.419, z = 29.598 },
	...
	VehicleSpawnPoint = {
		Pos	 = { x = -183.850, y = -1312.895, z = 30.682 },
		Size	= { x = 1.5, y = 1.5, z = 1.0 },
		Heading = 3.0,
		Type	= -1,
	},
	...
	VehicleDeleter = {
		Pos	 = { x = -171.421, y = -1304.097, z = 30.236 },
	...
	VehicleDelivery = {
		Pos	 = { x = -182.9, y = -1290.139, z = 30.213 },
		Size	= { x = 10.0, y = 20.0, z = 3.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type	= -1,
	},
}
