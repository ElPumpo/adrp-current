...
local blips = {
	...
	{name = blipNameFuelBoat, id = 427, x = 426.303, y = -3003.355, z = 1.00},
	--------- AVIONS ---------
...
boat_stations = {
	...
	{x = 426.303, y = -3003.355, z = 1.00, s = 34}
}
...
Citizen.CreateThread(function()
	...
	for k,v in ipairs(blips) do
		Citizen.Wait(10) -- fix blips without labels
	...
	TriggerServerEvent('esx_advancedfuel:requestStationPrices')
end)

RegisterNetEvent('esx_advancedfuel:sendStationPrices')
AddEventHandler('esx_advancedfuel:sendStationPrices', function(_stationPrices)
	StationsPrice = _stationPrices
end)
