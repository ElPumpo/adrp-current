		...
		if data.current.action == 'buy_vehicle' then
			...
			if type == 'car' then
				...
				if PlayerData.job.name == 'police' then
					authorizedVehicles = Config.PoliceAuthorizedVehicles[PlayerData.job.grade_name]
				elseif PlayerData.job.name == 'sheriff' then
					authorizedVehicles = Config.SheriffAuthorizedVehicles[PlayerData.job.grade_name]
				elseif PlayerData.job.name == 'state' then
					authorizedVehicles = Config.StateAuthorizedVehicles[PlayerData.job.grade_name]
				elseif PlayerData.job.name == 'securoserv' then
					authorizedVehicles = Config.SecuroServAuthorizedVehicles[PlayerData.job.grade_name]
				elseif PlayerData.job.name == 'usmarshal' then
					authorizedVehicles = Config.UsmarshalAuthorizedVehicles[PlayerData.job.grade_name]
				elseif PlayerData.job.name == 'dod' then
					authorizedVehicles = Config.dodAuthorizedVehicles[PlayerData.job.grade_name]
				elseif PlayerData.job.name == 'fib' then
					authorizedVehicles = Config.FibAuthorizedVehicles[PlayerData.job.grade_name]
				elseif PlayerData.job.name == 'doj' then
					authorizedVehicles = Config.DojAuthorizedVehicles[PlayerData.job.grade_name]
				end
			...
			elseif type == 'boats' then
				...
				local authorizedBoats = Config.AuthorizedBoats[PlayerData.job.name]
			...
			elseif type == 'helicopter' then
				...
				local authorizedHelicopters = Config.AuthorizedHelicopters[PlayerData.job.name]
