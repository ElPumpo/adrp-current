...
Config.Zones = {
	...
	Garages = {
		...
		{ -- Great Ocean Highway
			...
			BlipOverride = vector3(-1579.5, 5157.1, 19.6)
		},
...
Config.Vehicles = {
	{model = 'seashark', label = 'Seashark', price = 1000, props = {color1 = 0}},
	{model = 'suntrap', label = 'Suntrap', price = 3000},
	{model = 'jetmax', label = 'Jetmax', price = 7000},
	{model = 'tropic2', label = 'Tropic', price = 3000},
	{model = 'dinghy', label = 'Dinghy Black & Gold', price = 7500, props = {color1 = 1, color2 = 88}},
	{model = 'dinghy', label = 'Dinghy 4 seater', price = 7500},
	{model = 'speeder', label = 'Speeder', price = 10000},
	{model = 'squalo', label = 'Squalo (Random Color)', price = 7000, props = {pearlescentColor = 0}},
	{model = 'toro', label = 'Toro', price = 15000},
	{model = 'marquis', label = 'Marquis', price = 700},
	{model = 'submersible', label = 'Submersible', price = 100000}
}