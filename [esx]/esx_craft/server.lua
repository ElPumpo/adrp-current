...
RegisterServerEvent('esx_craft:getPlayerInventory')
AddEventHandler('esx_craft:getPlayerInventory', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	if xPlayer ~= nil then
		TriggerClientEvent('esx_craft:openMenu', _source, xPlayer.inventory)
	end
end)
...
RegisterServerEvent('esx_craft:craftItem')
AddEventHandler('esx_craft:craftItem', function(ingredients)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
