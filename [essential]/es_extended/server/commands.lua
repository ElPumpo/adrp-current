...
TriggerEvent('es:addGroupCommand', 'setgang', 'mod', function(source, args, user)
	if tonumber(args[1]) and args[2] and tonumber(args[3]) then
		local xPlayer = ESX.GetPlayerFromId(args[1])
	...
	params = {
		{ name = "id", help = 'ID'},
		{ name = "gang", help = 'Name of gang'},
		{ name = "grade_id", help = 'Gang grade'}
	}
})
...
TriggerEvent('es:addGroupCommand', 'settraffic', 'admin', function(source, args, user)
	TriggerClientEvent('esx:setTraffic', -1, args[1])
	TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Traffic set to ".. args[1])
end, function(source, args, user)
	TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Insufficient Permissions.")
end, {help = "Set traffic density", params = {{name = "density", help = "0.0 - 1.0"}}})

  TriggerEvent('es:addGroupCommand', 'setpeds', 'admin', function(source, args, user)
	TriggerClientEvent('esx:setPeds', -1, args[1])
	TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Peds set to ".. args[1])
end, function(source, args, user)
	TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Insufficient Permissions.")
end, {help = "Set ped density", params = {{name = "density", help = "0.0 - 1.0"}}})
